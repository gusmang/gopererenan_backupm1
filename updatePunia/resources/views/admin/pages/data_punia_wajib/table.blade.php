...
<div class="row" id="view_berita_div">
  <div class="col-12">
        ...
        ?>
            ...
            <div class="row form-group">
                <div class="col col-md-3">
                    Tahun : <p></p><input type="number"  class="form-control" name="t_date_year" id="t_date_year" value="<?php echo date("Y"); ?>" />
                </div>
                ...
                <div class="col col-md-2">
                   <div style="visibility:hidden;">Search</div>  <p></p><Button class="btn-primary"> <i class="fa fa-search"></i> Cari Data</Button>
                </div>
    ...
    <div class="col col-md-9" style="margin-top:30px; overflow:auto;">
        <table id="ikantable" class="table table-striped table-bordered display no-wrap datatable col-md-9">
        <thead>
            <tr>
                <th>No</th>
                <th>Nama Usaha</th>

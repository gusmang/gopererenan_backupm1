                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card" style="  background:#d9edf7;">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text text-center" style="font-size:36px;  color:#04488b;"><?php echo count($usaha); ?></p>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card" style=" background:#d9edf7;">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text text-center" style="font-size:36px;  color:#04488b;">0</p>
                                        <center><a href="#" class="btn btn-primary"><i class="fas fa-eye"></i>  &nbsp;  Cek Detail</a></center>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card" style="background:#d9edf7;">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text text-center"  style="font-size:36px; color:#04488b;"><?php echo $totalpunia; ?></p>
                                        <center><a href="#" class="btn btn-primary"><i class="fas fa-eye"></i>  &nbsp; Cek Detail</a></center>
                                    </div>
                                </div>

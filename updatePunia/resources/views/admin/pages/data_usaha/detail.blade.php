    ...
    <div class="col-12 col-md-12" style="margin-top:20px;">
        ...
        <div class="row">
            <div class="col col-md-4">
                ...
                <div class="col-md-12">
                <center>
                    <h2 style="font-size:21px;"><b><span id="div_usaha_nama"><?php echo $rows->nama_usaha; ?></span></b></h2>
            ...
            <div class="col col-md-8">
                ...
                <nav>
                  <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link" id="nav-punia-tab" data-toggle="tab" href="#nav-punia" role="tab" aria-controls="nav-punia" aria-selected="false">Data Punia</a>
                                 ...
                                 <div class="row">
                                  ...
                                  if($sts_byr == "y"){
                                      ...
                                      <div class="col-md-12" style="text-align:right;">
                                          <Button class="btn btn-primary" onclick="bayar_tagihan('<?php echo $index_bln; ?>','<?php echo $arrays; ?>');"><i class="fa fa-eye"></i> Bayar </Button>
                                      </div>
                                      <?php
                                  }
                                  ?>

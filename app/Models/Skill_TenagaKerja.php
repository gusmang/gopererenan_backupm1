...
{   
    ...
    public static function get_dataTenagaKerja_detail($request,$index){
        $data = Skill_TenagaKerja::where("id_skill_tenaga_kerja" , $index)->where("aktif","1")->orderBy("id_skill_tenaga_kerja" , "desc")->firstOrfail();

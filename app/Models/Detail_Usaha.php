...
{   
    ...
    public static function update_data_detail_usaha_front($request){

        $det_usaha = Usaha::where("id_usaha" , Session::get("id_usaha"))->firstOrfail();
        
        Detail_Usaha::where("id_detail_usaha",$det_usaha->id_detail_usaha)->update(
        array("nama_usaha"      => $request->text_title_new,
              "email_usaha"     => $request->text_email_usaha_new,
              "id_banjar"       => $request->text_desc_new,
              "no_telp"         => $request->text_telpkantor_new,
...
public static function post_data_detail_usaha_front($request){

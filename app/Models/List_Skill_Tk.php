...
{   
    ...
    public static function get_dataTenagaKerja_skill($request){
        $data = List_Skill_Tk::join("tb_skill_tenaga_kerja" , "tb_skill_tenaga_kerja.id_skill_tenaga_kerja","tb_list_skill_tenaga_kerja.id_skill")->where("tb_list_skill_tenaga_kerja.id_karyawan",$request->idk)->where("tb_list_skill_tenaga_kerja.aktif","1")->orderBy("id_list_skill_tenaga_kerja" , "desc")->get();

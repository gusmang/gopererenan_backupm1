...
{   
    ...
    public static function get_data_slides_by_position($request,$posisi){

        $data = Slides::where("posisi_gambar",$posisi)->where("aktif","1")->orderBy("id_gambar_home" , "desc")->get();
    ...
    public static function post_data_slides($request){
        ...
        $data->url_link                               = $request->t_url_link;
        ...
        $data->image_name_mobile                      = "";
        $data->image_pathname_mobile                  = "/GambarSlides/";
        $data->urutan                                 = 1;
    ...
    public static function post_gambar_baru_edit($request){
        ...
        $array_input["url_link"]                = $request->edit_url_link;

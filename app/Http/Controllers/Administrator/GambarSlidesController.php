...
class GambarSlidesController extends BaseController
{
        ...
        public function post_data_kategori(Request $request){
            
            $postdata = Kategori_Slides::post_data_kategori($request);
            
            return redirect(Config::get('myconfig.adminPage')."/datakategori_slides")->with(['success' => 'Data Kategori Slides Berhasil ditambahkan']);
        }

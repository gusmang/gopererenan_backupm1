...
class KaryawanController extends BaseController
{
        ...
        public function not_approve_data_karyawan(Request $request){
            $karyawan = Jadwal_Interview::not_approve_data_karyawan($request);
        ...
        public function data_skill_tk(Request $request){
            $skill_tk = List_Skill_Tk::get_dataTenagaKerja_skill($request);

            return response()->json($skill_tk);
            //return view('admin.pages.data_tenagakerja.skilltable' ,compact('skill_kerja'));
        }

...
<center>
    <h4 class="title-laporan-new"> Data Laporan Dalam Masa Tenggang </h4>
</center>


<center>
    <h5 class="sub-title-laporan-new"> Periode <?php echo $bulan. " ".$tahun; ?> </h5> <br />
    <?php
    if(isset($banjar)){
        ?>
            <h5 class="sub-title-laporan-new">
                <?php echo $databanjar->nama_banjar; ?> <br />
                <small> <?php echo $databanjar->alamat_banjar; ?> </small>
            </h5>
        <?php
    }
    ?>
...
<table style="width:100%; border:1px solid #999;" cellpadding="10" cellspacing="0">
    ...
    <tr>
            <td align="center" style="border-right:1px solid #DDD; width:50%;">

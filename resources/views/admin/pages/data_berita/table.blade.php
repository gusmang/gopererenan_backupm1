 ...
 <div class="row" id="view_berita_div">
    ...
    var level_user = "<?php echo Session::get('level'); ?>";
        ...
        jQuery(document).ready(function() {
            ...
            $.ajax({
                type:"get",
                url:url_menu_apis+"/ambil_listberita",
                data:"",
                dataType:"json",
            ...
            $.ajax({
                type:"get",
                url:url_menu_apis+"/ambil_listkategori_awal",
                data:"",
                dataType:"json",
                success:function(data){
                //console.log("databerita" , data);
        ...
        function open_detail(id){
            ...
            jQuery.ajax({
                type:"GET",
                url:url_menu_apis+"/ambil_berita",
                dataType:"json",
                data:"",
                success:function(data){
        ...
        function ambil_berita(id){
            ...
            $.ajax({
                type:"get",
                url:url_menu_apis+"/ambil_listberita_kategori",
                data:"id="+id,
                dataType:"json",
                success:function(data){
                //console.log("databerita" , data);
        ...
        function editModal(id){
            ...
            jQuery.ajax({
                type:"GET",
                url:url_menu_apis+"/ambil_berita"+"/"+id,
                dataType:"json",
                data:"",
                async:false,
                success:function(data){

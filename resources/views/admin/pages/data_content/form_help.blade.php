            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <strong>Form</strong> Help
                    </div>
                    <div class="card-body card-block">

                    <form id="form_multi" enctype="multipart/form-data" method="post" action="<?php echo url(Config::get('myconfig.adminPage').'/updatehelp_policy'); ?>">
                        {{ csrf_field() }}

                        <input type="hidden" name="t_index" id="t_index" value="<?php echo $help->id_help; ?>" />

                        <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Isi Berita</label></div>
                            <div class="col-12 col-md-9">
                                <textarea name="DSC" class="materialize-textarea"><?php echo $help->deskripsi; ?></textarea>

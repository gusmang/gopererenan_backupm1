                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card" style="background:#d9edf7;">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text text-center" style="font-size:24px;  color:#04488b;"><?php echo format_rupiah($totalsumbangan); ?></p>
...
<script type="text/javascript">
        ...
        $.ajax({
            type:"GET",
            data:"",
            url:"<?php echo url(Config::get('myconfig.adminPage').'/get_danapunia_range'); ?>",
            dataType: "json",
            async:false,
            success:function(data){
                ...
                $.each(parses , function(index,element){
                     ...
                     total_punia.push(parseInt(element.punia));
        ...
        $.ajax({
            type:"GET",
            data:"",
            url:"<?php echo url(Config::get('myconfig.adminPage').'/get_danasumbangan_range'); ?>",
            dataType: "json",
            async:false,
            success:function(data){
                
                var parses = JSON.parse(data.total_sumbangan);

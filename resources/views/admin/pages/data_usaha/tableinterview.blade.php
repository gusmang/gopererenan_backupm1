...
<div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
    <form id="form_maintenance_usaha" name="form_maintenance_usaha" enctype="multipart/form-data" method="post" action="<?php echo url(Config::get('myconfig.adminPage')."/submit_post_add_usaha"); ?>">
            ...
            <table id="ikantable" class="table table-striped table-bordered display no-wrap datatable"
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo url(Config::get('myconfig.adminPage').'/detail_usaha/'.$rows->id_usaha); ?>"> <i class="fa fa-eye"></i> Detail </a> </td>
                        </tr>

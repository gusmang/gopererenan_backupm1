            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="largeModalLabel">Form Bayar Tagihan</h4>
                     ...
                     <input type="hidden" name="t_kode_invoice" id="t_kode_invoice" />
                ...
                <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <span id="sp_pembayaran_new">
                                    Rp. <?php echo format_rupiah($rows->minimal_bayar); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12" style="margin-top:10px;">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="date" name="tanggal_bukti_pembayaran" id="tanggal_bukti_pembayaran" value="<?php echo date('Y-m-d'); ?>" />
                                <input type="date" name="tanggal_bukti_pembayaran_riil" id="tanggal_bukti_pembayaran_riil" value="<?php echo date('Y-m-d'); ?>" style="display:none;" />
                    ...
                    <div class="col-md-12" style="margin-top:10px;">
                        <div class="row">
                            ...
                            <div class="col-md-1">:</div>
                            <div class="col-md-8"><input type="file" name="f_bukti_pembayaran" id="f_bukti_pembayaran" accept=".jpg,.jpeg,.png" /> <br /> <small><i>format file *jpg , png</i></small></div>
                        </div>
                    </div>
    ...
    <div class="animated fadeIn">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <form method="post"  id="frm_berita" name="frm_berita" action="<?php echo url(Config::get('myconfig.adminPage')."/update_post_add_usaha"); ?>">
...
<div class="modal fade" id="largeModal_edit" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
    <form id="form_maintenance_usaha" name="form_maintenance_usaha" enctype="multipart/form-data" method="post" action="<?php echo url(Config::get('myconfig.adminPage')."/update_post_add_usaha"); ?>">
                    ...
                    <div class="tab-pane fade" id="nav-credentials" role="tabpanel" aria-labelledby="nav-credentials-tab">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">New Password :</label></div>
                                <div class="col-12 col-md-9">
                                    <input type="password" id="text_password_new" name="text_password_new"  class="form-control">
 ...
 <div class="row" id="view_berita_div">
                                  ...
                                  if($sts_byr == "y"){
                                      ?>
                                        <div class="col-md-12" style="text-align:right; margin-top:-15px;">
                                            <b>Sudah Bayar</b> <br />
                                            <?php //echo tgl_indo($arr_danas[$index_dana]->tanggal_pembayaran); ?> 
                                    ...
                                    ?>
                                        <div class="col-md-12" style="text-align:right; margin-top:-15px;">
                                            ...
                                            <?php echo $arr_danas[$index_dana]->tanggal_pembayaran; ?> <br />
                                            <?php echo $arr_danas[$index_dana]->metode; ?> <br />
                                            <button class="btn btn-warning" onclick="bayar_tagihan('<?php echo $index_bln; ?>','<?php echo $arrays; ?>','<?php echo $arr_danas[$index_dana]->id_dana_punia; ?>');"><i class="fa fa-check"></i> Approve</button>
                                        </div>
                                    <?php
                                    $index_dana++;
                                    //$index_dana++;
                                      ...
                                      <div class="col-md-12" style="text-align:right;">
                                          ...
                                          <div <?php echo $not_reg; ?>><small> - Not Registered - </small></div>
                                      </div>
                                      <?php
                                  }
                                  ?>
    ...
    function bayar_tagihan(index,bulan,inv){
    ...
    function submit_pembayaran_form(form){
        ...
        var url_post = url_menu_apis+"/"+"post_pembayaran_baru/"+"manual";

        var kd_inv = $("#t_kode_invoice").val();

        if(kd_inv != ""){
            url_post = url_menu_apis+"/"+"update_pembayaran_baru/"+$("#t_kode_invoice").val();
        }
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                '<br />'+data[0].metode+'<br />'+
                '<button class="btn btn-success" onclick="open_detail_pembayaran('+data[0].id_dana_punia+');"><i class="fa fa-eye"></i> Detail</button>'+
                '</div>';
                //if(data == "success"){
                $("#largeModal").modal("hide");
                $("#f_bukti_pembayaran").val("");
                   // $("#btn_reset").click();

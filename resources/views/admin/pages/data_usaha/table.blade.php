                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9"><input type="file" id="edit_f_upload_gambar" onchange="document.getElementById('edit_current_desktop_image').src = window.URL.createObjectURL(this.files[0]);" name="edit_f_upload_gambar" class="form-control" accept=".jpg,.jpeg,.png" /> <!-- <small class="form-text text-muted">Masukkan Nama Kategori</small> --> </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9"><input type="file" id="edit_f_upload_gambar_mobile" name="edit_f_upload_gambar_mobile" onchange="document.getElementById('edit_current_mobile_image').src = window.URL.createObjectURL(this.files[0]);" class="form-control" accept=".jpg,.jpeg,.png" /> <!-- <small class="form-text text-muted">Masukkan Nama Kategori</small> --> </div>
        ...
        <div class="card-body card-block">
                ...
                <nav>
                  <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link active" id="nav-home-tab" onclick="$('#btn-next-submit').show(); $('#btn-confirm-submit').hide(); currentTabs=0" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Detail Usaha</a>
                    <a class="nav-item nav-link disabled" id="nav-profile-tab" onclick="$('#btn-next-submit').show(); $('#btn-confirm-submit').hide(); currentTabs=1" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Penanggung Jawab</a>
                    <a class="nav-item nav-link disabled" id="nav-credentials-tab" data-toggle="tab" href="#nav-credentials" role="tab" aria-controls="nav-credentials-tab" aria-selected="false" onclick="$('#btn-next-submit').hide(); $('#btn-confirm-submit').show(); $('#text_username_new').val($('#text_email_usaha_new').val());">Credentials</a>
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        ...
                        <div id="detail_usaha">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="text_title_new" name="text_title_new" required="required" class="form-control"><small class="form-text text-muted">Required</small></div>
                                </div>
                                        ...
                                        ?>
                                                ...
                                                <small class="form-text text-muted">Required</small></div>
                                            </div>
                                
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Minimal Pembayaran :  *)</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="text_minimal_pembayaran" name="text_minimal_pembayaran" required="required" class="form-control"><small class="form-text text-muted">Required</small></div>
                                </div>
                                
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Email Usaha :  *)</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="text_email_usaha_new" name="text_email_usaha_new" required="required" class="form-control"><small class="form-text text-muted">Required</small></div>
                                </div>
                                
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">No.Telp Kantor Usaha :</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="text_telpkantor_new" name="text_telpkantor_new" class="form-control"></div>
                                </div>
                                
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">No.Telp WA :  *)</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="text_notelp_was" name="text_notelp_was" required="required" class="form-control"><small class="form-text text-muted">Required</small></div>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="text_google_maps" name="text_google_maps" required="required" class="form-control"><small class="form-text text-muted"></small></div>
                                </div>

                                <div class="row form-group"  style="margin-top:30px;">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Gambar logo :</label></div>
                                    <div class="col-12 col-md-9"><input type="file" id="f_upload_gambar_mobile" name="f_upload_gambar_mobile"  accept=".jpg,.jpeg,.png" class="form-control"><small class="form-text text-muted" ></small></div>
                                </div>
                                </div>
                ...
                <div class="modal-footer">
                    <div style="color:#FF0000; display:none;" id="validation_errors"> <i class="fa fa-times"></i> Mohon Lengkapi input yang di wajibkan  </div>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>

                    <button type="button" class="btn btn-success" onclick="next_steps();" id="btn-next-submit">Next <i class="fa fa-chevron-right"></i> </button>
                    
                    <button type="submit" style="display:none;" class="btn btn-primary" id="btn-confirm-submit">Confirm</button>

                    <button type="reset" style="display:none;" class="btn btn-danger" id="btn-confirm-reset">Reset</button>
                </div>
...
<div class="content mt-3" id="div_form_berita" style="display:none;">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-9 col-md-4"><input type="file" id="uploadinput" name="uploadinput" placeholder="Text" class="form-control" accept=".jpg,.jpeg,.png" /><small class="form-text text-muted">Upload Foto Berita</small></div>
 ...
 <div class="row" id="view_berita_div">
                ...
                <div class="row form-group">
                     ...
                     <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                    Nama Usaha : <br />
                                    <input type="text" name="nama_usaha" id="nama_usaha" class="form-control" value="<?php echo $nama_usaha; ?>" />
                            </div>
                            ...
                            <div class="col-md-3">
                                    ...
                                    <select name="banjar" id="banjar" class="form-control">
                                        ...
                                        <?php
                                            $selecteds = "";
                                            foreach($banjar as $rows_banjar){
                                                $selecteds = $rows_banjar->id_data_banjar == $banjarnew ? "selected='selected'" : "";
                                            ?>
                                                <option value="<?php echo $rows_banjar->id_data_banjar; ?>" <?php echo $selecteds; ?> ><?php echo $rows_banjar->nama_banjar; ?></option>
                                            <?php
                                            }
                                        ?>
                                    </select>
                            ...
                            <div class="col-md-2">
                                    <br />
                                    <button name="btn_input_new" id="btn_input_new" class="form-control btn-primary">
    ...
    <div class="col-12 col-md-12" style="margin-top:20px; overflow:auto;">
            <table id="ikantable" class="table table-striped table-bordered display no-wrap datatable"
                ...
                <tbody>
                        ...
                        $no = 1;
                        if(isset($_GET['page'])){
                            $no = isset($_GET['page']) || $_GET['page'] > 1 ? $no = (((($_GET['page']-1) * Config::get('myconfig.limit_page')) * $no)+1) : $no;
                        }
                        foreach($usaha as $rows){
                            ...
                            if($rows->aktif_status == "0"){
                                $url_appr = url(Config::get('myconfig.adminPage')."/approve_usaha/".$rows->id_usaha);
                        ...
                        <tr>
                            <td><?php echo $no; ?></td>
                            <td><b> <?php echo $rows->nama_usaha; ?></b><br /><small><?php echo $rows->alamat_banjar; ?></small><br /><small><?php echo $rows->nama_banjar; ?></small></td>
                            <td><?php echo $rows->email_usaha; ?></td>
                            <td><?php echo $rows->no_wa; ?></td>
                            <td><?php echo $act; ?></td>
                            <!--<td><?php //echo $rows->nama; ?></td>-->
                            <td><a href="<?php echo url(Config::get('myconfig.adminPage').'/detail_usaha/'.$rows->id_usaha); ?>"> <i class="fa fa-eye"></i> Detail </a> <br /> <?php echo $btn; ?> </td>
                        </tr>
            ...
            <div id="pagination">
                    ...
                    <div style="float:right; margin-top:20px; margin-right:30px;">
                        <ul class="pagination">
                            @include('admin.pagination.limit_links', ['paginator' => $usaha])
                        </ul>
                    </div>
            </div>
    ...
    function next_steps(){
        var req_tabs1 = $("#text_title_new").val();
        var req_tabs2 = $("#cmb_kategori_usaha").val();
        var req_tabs3 = $("#text_minimal_pembayaran").val();
        var req_tabs4 = $("#text_email_usaha_new").val();
        //var req_tabs5 = $("#text_telpkantor_new").val();
        var req_tabs6 = $("#text_notelp_was").val();
        var req_tabs7 = $("#t_alamat_usaha").val();
        var req_tabs8 = $("#text_desc_new").val();


        var req2_tabs1 = $("#text_namapngg_new").val();
        var req2_tabs2 = $("#text_statuspngg_new").val();
        var req2_tabs3 = $("#text_alamat_pngg_new").val();
        var req2_tabs4 = $("#text_email_usaha_new").val();
        var req2_tabs5 = $("#text_notelp_pngg_new").val();

        if(currentTabs == 0){
            if(req_tabs1 != "" && req_tabs2 != "" && req_tabs3 != "" && req_tabs4 != "" && req_tabs6 != "" && req_tabs7 != "" && req_tabs8 != ""){
            ...
            if(req2_tabs1 != "" && req2_tabs2 != "" && req2_tabs3 != "" && req2_tabs4 != "" && req2_tabs5 != ""){
                $("#nav-credentials-tab").removeClass("disabled");
                $("#nav-credentials-tab").click();
                $("#validation_errors").hide();

                $("#btn-next-submit").hide();
                $("#btn-confirm-submit").show();
            } 
            else{
                // scroll_to();
                $("#validation_errors").show();

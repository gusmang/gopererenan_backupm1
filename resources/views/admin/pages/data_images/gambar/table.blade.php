                    ...
                    <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Url Link</label></div>
                                                <div class="col-12 col-md-9"><input type="text" id="edit_url_link" name="edit_url_link" class="form-control"><small class="form-text text-muted">Masukkan Alt Desc</small></div>
                                            </div>

                                            <div class="row form-group">
                                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Gambar Desktop</label></div>
                    ...
                    <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Url Link</label></div>
                                                <div class="col-12 col-md-9"><input type="text" id="t_url_link" name="t_url_link"  class="form-control"><small class="form-text text-muted">Masukkan Alt Desc</small></div>
                                            </div>

                                            <div class="row form-group">
                                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">File Gambar</label></div>
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(data == "success"){
                    ...
                    window.location = url_menu_apis+"/"+"datagambar_slides";
                    $("#btn_reset").click();
                }
            }
        });

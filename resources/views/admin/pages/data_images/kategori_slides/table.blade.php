...
<div class="container-fluid">
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="largeModalLabel">Edit Data Kategori</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <form id="form_multi" method="post" action="<?php echo url(Config::get('myconfig.adminPage')."/post_data_kategori"); ?>">
                                 ...
                                 <div class="col-lg-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <strong>Tambah</strong> Data Kategori
                                                    </div>
                                                    <div class="card-body card-block">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="text" id="t_nama_banjar" name="t_nama_banjar" required="required" placeholder="" class="form-control"><small class="form-text text-muted">Masukkan Nama Kategori</small></div>
                                                            </div>
 ...
 <div class="row">
    ...
    $('#ikantable').DataTable();
        ...
        //         "ajax": {
        //             "url": "<?php //echo url(Config::get('myconfig.adminPage').'/ambil_listbanjar'); ?>",
        //             "dataSrc": ""
        //         },
        //         columns: [
        //             { "data": 'no' },
            ...
            if(conn == true){
                jQuery.ajax({
                    ...
                    success:function(data){
                        //table.ajax.reload();
                        window.location = "<?php echo url(Config::get('myconfig.adminPage').'/databanjar'); ?>";
                    }
                })
            }
        }

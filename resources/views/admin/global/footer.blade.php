    ...
    <script src="<?php echo url('assets/src/'); ?>/assets/libs/chartist/dist/chartist.min.js"></script>
    <script src="<?php echo url('assets/src/'); ?>/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js"></script>
    ...
    <script src="<?php echo url('assets/src/'); ?>/dist/js/pages/dashboards/dashboard1.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        // var url_menu_apis  = "<?php //echo url("/".Config::get("myconfig.devUrl")); ?>";
        // var url_menu_asset = "<?php //echo url("/".Config::get("myconfig.assetsUrl")); ?>";

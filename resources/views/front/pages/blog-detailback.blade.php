            ...
            <!-- <p class="comment-notes" style="font-size:12px;"><span id="email-notes">Alamat email Anda tidak akan dipublikasikan.</span> <br /><span class="required-field-message" aria-hidden="true">Ruas yang wajib ditandai <span class="required" aria-hidden="true">*</span></span></p> -->
                ...
                <div class="col-md-12" style="font-size:12px;">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <textarea class="form-control" rows="8" style="max-height:400px;"></textarea>
                        </div>
                    </div>
                    </div>
                ...
                <div class="col-md-12"  id="div-new-design">
                ...
                <div class="col-md-12" style="margin-top:20px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-2">
                            <img src="<?php echo url('public/icon_anonymous-user.png'); ?>" width="60" style="border-radius:50%;" />
                        </div>
                        

                        <div class="col-md-10 col-10">
                            <span> <b> <h5 style="font-size:12px; color:#333;"> Nama User &nbsp; <span> &bull; <span style="font-size:12px; font-weight:normal; color:#444;"> &nbsp;12 Jan 2022 </span> </span></h5> </b> </span>
                            <span> <b> <h5 style="font-size:10px; font-weight:normal;"> Aktor Tom Hanks menambah daftar orang yang terjangkit virus Corona atau Covid-10. Tak sendiri, sang istri, Rita WIlson juga terdampak virus yang merenggut ribuan nyawa tersebut.
                        </div>
                ...
                <div class="col-md-12" style="margin-top:20px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 col-10">
                            <span> <b> <h5 style="font-size:13px; color:#333;"> Nama User &bull; </h5> </b> </span>
                            <span> <b> <h5 style="font-size:11px; font-weight:normal;"> Aktor Tom Hanks menambah daftar orang yang terjangkit virus Corona atau Covid-10. Tak sendiri, sang istri, Rita WIlson juga terdampak virus yang merenggut ribuan nyawa tersebut.
                        </div>

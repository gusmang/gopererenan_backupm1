...
<div id="header" style="display:none;">
    ...
    <div id="container-body-images">
            <div id="header-images">
                <img src="https://www.spektrum-ntt.com/data/img/article/WhatsApp_Image_2020-06-23_at_06_44_09.jpeg" />
            </div>
            ...
            <div class="full-width padding">
               <div class="float-left sub-header"> <h4> Rp. <?php echo format_rupiah($donate); ?> </h4> </div> <div class="float-left capts" style="margin-left:10px;"> <small> terkumpul dari tahun <?php echo date("Y"); ?> </small> </div> 
            </div>
            <br clear="all" />
            ...
            <div class="full-width padding">
               <div class="float-left"> <h4 style="font-size:28px; font-weight:bold; color:rgb(0, 174, 239);"> <b> <?php echo $count; ?> <small style="font-size:12px; color:#000000;"> Donasi Terkumpul </small>  </b> </h4></div> 
            </div>
            <p></p>
        ...
        <center>
            <a href="<?php echo url('daftar-seluruh-sumbangan'); ?>"> <div style="width:120px; color:rgb(100, 174, 239); font-size:12px; background:rgb(231, 245, 255); margin-top:10px; border-radius:10px; padding:5px;"> Lihat Semua <i class="bi bi-chevron-down"></i> </div> </a>
        </center>
